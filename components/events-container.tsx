...
const EventsContainer: NextPage = () => {
  return (
    <div className="rounded-lg shadow-[0px_1px_2px_rgba(0,_0,_0,_0.06)] overflow-hidden flex flex-col items-center justify-start relative text-left text-sm text-primary-black100 font-p-xsmall1 border-[1px] border-solid border-primary-black101">
      <img
        className="absolute my-0 mx-[!important] top-[calc(50%_-_132px)] left-[226px] w-[640px] h-[640px] shrink-0 object-cover z-[0]"
        alt=""
        src="../qmuvthl1lhenqcqrdfua1svw5ekyajmssfkperkxy95g2x-1@2x.png"
      />
          ...
          <div className="flex flex-col items-start justify-start gap-[16px]">
            <div className="flex flex-col items-start justify-start gap-[12px]">
              <div className="flex flex-row items-center justify-start gap-[8px]">
                ...
                <div className="flex flex-row items-center justify-start">
                  ...
                  <div className="rounded-tl-none rounded-tr-lg rounded-br-lg rounded-bl-none bg-primary-black101 [backdrop-filter:blur(16px)] flex flex-row py-[3px] pr-2 pl-0 items-start justify-start">
                    <b className="relative leading-[150%]">Harvest</b>
                  </div>
                </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[4px] text-base">
                ...
                <div className="flex flex-row items-end justify-start gap-[10px] text-3xl">
                  <b className="relative leading-[100%]">Manure</b>
              ...
              <div className="flex flex-row items-start justify-start gap-[16px]">
                ...
                <div className="flex flex-row items-start justify-start gap-[4px]">
                  <b className="relative leading-[150%]">44</b>
                  <div className="relative leading-[150%]">Success</div>
                </div>
                <div className="flex flex-row items-start justify-start gap-[4px]">
                  <b className="relative leading-[150%]">8</b>
                  <div className="relative leading-[150%]">Processing</div>
                </div>
                <div className="flex flex-row items-start justify-start gap-[4px]">
                  <b className="relative leading-[150%]">2</b>
              ...
              <div className="relative w-[709px] h-4 shrink-0">
                ...
                <div className="absolute top-[0px] left-[0px] rounded-lg [background:linear-gradient(270deg,_rgba(0,_0,_0,_0.5),_rgba(255,_255,_255,_0.5)),_#ff4800] w-[295px] h-4" />
              </div>
            </div>
            <div className="flex flex-row items-center justify-start gap-[8px] text-base">
              ...
              <div className="flex flex-row py-0 pr-0 pl-2 items-center justify-start gap-[8px]">
